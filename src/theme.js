...
export const blueTheme = {
  body: "#EDF9FE", // Light blue for the background
  text: "#001C55", // Dark blue for main text
  expTxtColor: "#000a12", // Slightly darker text color
  highlight: "#A6E1FA", // Light blue for highlights
  dark: "#00072D", // Dark blue for darker elements
  secondaryText: "#7F8DAA", // Lighter blue for secondary text
  imageHighlight: "#0E6BA8", // Blue for image highlights
  compImgHighlight: "#E6E6E6", // Light gray for complementary image highlights
  jacketColor: "#0A2472", // Dark blue for special elements
  headerColor: "#0E6BA877", // Header color with slight transparency
  splashBg: "#001C55", // Transparent dark blue for splash background
};
